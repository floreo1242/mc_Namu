...
class QuestAcceptInventory(
    ...
    companion object {
        ...
        val acceptItemStack: ItemStack = createItemStack(Material.GOLDEN_AXE, "&9수락", listOf("&f클릭 시 퀘스트를 수락합니다."), durability = 4)
        val disposeItemStack: ItemStack = createItemStack(Material.GOLDEN_AXE, "&c거절", listOf("&f클릭 시 퀘스트를 거절합니다."), durability = 5)
    }
