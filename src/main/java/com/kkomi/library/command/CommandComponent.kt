...
open class CommandComponent constructor(val usage: String, val description: String, val permission: String? = null, argumentsLength: Int = 0) {

    val argumentsLength: Int

    constructor(usage: String, description: String, argumentsLength: Int) : this(usage, description, null, argumentsLength)
