...
import com.kkomi.treeisland.shop.command.*
import com.kkomi.treeisland.shop.eneity.KeywordStuff
import com.kkomi.treeisland.shop.eneity.Stuff
import com.kkomi.treeisland.shop.listener.ShopInventoryListener
...
class ShopPlugin(dataFolder: File, plugin: JavaPlugin) : SubMainManager(dataFolder, plugin) {
    ...
    override fun setupManagers() {
        shopManager = ShopManager(dataFolder, plugin.logger)
    }
