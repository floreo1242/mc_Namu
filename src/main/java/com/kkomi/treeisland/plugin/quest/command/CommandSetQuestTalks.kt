...
class CommandSetQuestTalks(usage: String, description: String, argumentsLength: Int) : QuestCommandComponent(usage, description, argumentsLength) {
    ...
    override fun onCommand(commandSender: CommandSender, label: String, command: Command, componentLabel: String, args: ArgumentList, quest: Quest): Boolean {
        ...
        commandSender.sendInfoMessage(QuestMessage.QUEST_SET_TITLE)
        return true
    }
